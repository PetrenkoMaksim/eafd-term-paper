...
def main():
    coles = pd.read_pickle('/home/jovyan/sakhno/turbo-stats/embeddings/rosbank/coles.pickle')
    coles[COL_ID] = coles[COL_ID].astype(int)
    test_ids = pd.read_csv('/home/jovyan/sakhno/turbo-stats/data/rosbank/test_ids.csv')
    test_ids[COL_ID] = test_ids[COL_ID].astype(int)

    labels = pd.read_csv('/home/jovyan/sakhno/turbo-stats/data/rosbank/target.csv')
